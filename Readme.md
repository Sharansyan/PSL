...
![Figure 1: (a) Building before Collapse, (b) Building after Collapse.](src/building.jpg)
...
![Figure 2: Field examination of the disaster area: (a) weak concrete quality and straight reinforcement; (b) insufficient transversal reinforcement; (c) weak concrete material; (d) poor reinforcement detail and cover concrete; (e) insufficient bond between concrete and reinforcement; and (f) column found in debris with variable cross section](https://github.com/Sharansyan/PSL/blob/main/src/field%20examination.jpg)
...
![Figure 3: 3D model of the building](https://github.com/Sharansyan/PSL/blob/main/src/3d%20model.jpg)
...
![Figure 4: Architectural plan of the building](https://github.com/Sharansyan/PSL/blob/main/src/structure%20plan.jpg)
